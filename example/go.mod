module github.com/klass-lk/ginboot/example
...
require (
	...
	github.com/klass-lk/ginboot/telemetry v0.0.0-00010101000000-000000000000
...
replace github.com/klass-lk/ginboot/telemetry => ../telemetry
