...
description: "One generic repository interface over MongoDB, SQL and DynamoDB, with built-in CRUD, pagination and custom repository support."
icon: Database
---
...
<Tabs items={['MongoDB', 'SQL', 'DynamoDB']}>
...
<Callout type="warn" title="Filtering falls back to Scan">
